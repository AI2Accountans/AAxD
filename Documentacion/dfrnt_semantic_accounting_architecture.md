# The Semantic Data Pipeline and Ingestion Architecture ("Momento 0")
...
## 3. The Solution: A Unified Semantic Data Hub
To solve this, we have designed a **Semantic Data Pipeline** that decouples storage, business logic, and semantic querying, placing DFRNT and TerminusDB at the core of the Enterprise Knowledge Graph.
...
- **Accounting Logic:** Business rules, tax calculations, and Chart of Accounts (PUC) assignments are mapped.
...
### Phase 4: Downstream Export (Legacy Integration)
TerminusDB is not a data silo; it is a semantic engine capable of downstream export.
- **Extracting Ledger Entries:** Using TerminusDB's native querying capabilities (WOQL/GraphQL), the complex semantic graph can be flattened on-demand.
