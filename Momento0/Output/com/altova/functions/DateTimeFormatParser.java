...
public class DateTimeFormatParser {
	...
	protected String getComponentValue( DateTime dtData, char cComponent) {
		...
		switch (cComponent) {
			...
			break;
			case 'w': sValue.append( getWeekOfMonth( dtData ) ); break;
	...
	protected int getWeekOfMonth( DateTime dtData )
	{
		DateTime date = new DateTime(dtData.getYear(), dtData.getMonth(), 1);
		int weekday1st = date.getWeekday() + 1;
		int dayInMonth = dtData.getDay();
		...
		return (int)(Math.ceil((dayInMonth - dayOfFirstMonday) / 7)) + weekIncrement;
	}
