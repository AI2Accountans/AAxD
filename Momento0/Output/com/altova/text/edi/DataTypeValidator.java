...
public abstract class DataTypeValidator {
	...
	static public void padRight( StringBuffer sBuffer, char cPad, int toPad) {
		if (toPad > 0) {
	...
	static public void padLeft( StringBuffer sBuffer, char cPad, int toPad) {
		if (toPad > 0) {
			StringBuffer spad = new StringBuffer();
			for (int i=0; i< toPad; ++i)
				spad.append(cPad);
			sBuffer.insert(0, spad);
		}
	}
	...
	public boolean compare(String s1, String s2) { return s1.trim() == s2.trim(); }
