...
public class Generator implements ITextNode {
	...
	private Vector<ITextNode> mPath;

	public Generator() {
		m_Children = new com.altova.text.TextNodeList(this);
		mPath = new Vector<ITextNode>();
	}
	...
	public Vector<ITextNode> getPath() { return mPath; }
	...
	public void leaveElement(String name) {
		...
		mPath.remove(m_Current);
		m_Current = m_Current.getParent();
	}

	public ITextNode insertElement(String name, String value, byte nodeClass) {
		TextNode node = new TextNode(m_Current, name, nodeClass);
		node.setValue(value);
		return node;
	}
