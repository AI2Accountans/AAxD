...
public class WebServiceCall {
	...
	public WebServiceCall(String endpointURL, String WSDLTargetNamespace, String operationName, String soapAction, String encoding, int timeout, byte style, byte soapVer) {
	...
	public WebServiceCall(String endpointURL, String opLocation, byte contentType, String encoding, int timeout, byte style, byte soapVer) {
		this.endpointURL = endpointURL;
	...
	public org.w3c.dom.Node call (org.w3c.dom.Node in) throws Exception {
		...
		if (style == HTTP_GET || style == HTTP_POST) {
			...
			if (style == HTTP_GET) {
				...
				conn.setReadTimeout(Math.max(timeout*1000, 0));
