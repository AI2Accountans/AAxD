...
public class GoogleSheets_TypeInfo {
	// namespaces indices
	...
	public static class _altova_mi_altova_RowsType {
		...
		public static final int _entryNumber = _altova_mi_altova_RowsType.begin ;
		public static final int _lineNumber = 2 ;
		public static final int _enteredBy = 3 ;
		public static final int _enteredDate = 4 ;
		public static final int _postingDate = 5 ;
		public static final int _organizationIdentifier = 6 ;
		public static final int _sourceJournalID = 7 ;
		public static final int _sourceJournalDescription = 8 ;
		public static final int _accountMainID = 9 ;
		public static final int _accountMainDescription = 10 ;
		public static final int _amount = 11 ;
		public static final int _debitCreditCode = 12 ;
		public static final int _identifierCode = 13 ;
		public static final int _identifierDescription = 14 ;
		public static final int _identifierType = 15 ;
		public static final int _documentTypeDescription = 16 ;
		public static final int _documentNumber = 17 ;
		public static final int _documentDate = 18 ;
		public static final int _measurableCode = 19 ;
		public static final int _measurableID = 20 ;
		public static final int _measurableDescription = 21 ;
		public static final int _measurableQuantity = 22 ;
		public static final int _measurableUnitOfMeasure = 23 ;
		public static final int _measurableCostPerUnit = 24 ;
...
// Array of all types with pointers to members:
	...
	private static class MemberInfoCreator {
		private void initMembers0(InfoBinderInterface binder, MemberInfo[] members) {
			...
			members[1] = new MemberInfo (binder, "", "entryNumber", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[2] = new MemberInfo (binder, "", "lineNumber", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[3] = new MemberInfo (binder, "", "enteredBy", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[4] = new MemberInfo (binder, "", "enteredDate", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[5] = new MemberInfo (binder, "", "postingDate", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[6] = new MemberInfo (binder, "", "organizationIdentifier", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[7] = new MemberInfo (binder, "", "sourceJournalID", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[8] = new MemberInfo (binder, "", "sourceJournalDescription", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[9] = new MemberInfo (binder, "", "accountMainID", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[10] = new MemberInfo (binder, "", "accountMainDescription", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[11] = new MemberInfo (binder, "", "amount", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[12] = new MemberInfo (binder, "", "debitCreditCode", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[13] = new MemberInfo (binder, "", "identifierCode", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[14] = new MemberInfo (binder, "", "identifierDescription", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[15] = new MemberInfo (binder, "", "identifierType", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[16] = new MemberInfo (binder, "", "documentTypeDescription", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[17] = new MemberInfo (binder, "", "documentNumber", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[18] = new MemberInfo (binder, "", "documentDate", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[19] = new MemberInfo (binder, "", "measurableCode", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[20] = new MemberInfo (binder, "", "measurableID", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[21] = new MemberInfo (binder, "", "measurableDescription", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[22] = new MemberInfo (binder, "", "measurableQuantity", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[23] = new MemberInfo (binder, "", "measurableUnitOfMeasure", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[24] = new MemberInfo (binder, "", "measurableCostPerUnit", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);

			members[25] = new MemberInfo (binder, "", "", _altova_ti_altova_stringType, _altova_ti_altova_string2, 0|MemberInfo.IS_ATTRIBUTE, 1, 1);
